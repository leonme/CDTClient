sap.ui.define([
	...
	sap.galilei.ui5.EditorSettings.viewBackgroundFill = "#EEDDCC";
	sap.galilei.ui5.EditorSettings.pageBackgroundFill = "#FFEECC";
	sap.galilei.ui5.EditorSettings.useContextButtonPad = true;

	var CController = Controller.extend("com.sap.cdt.controller.OperationRouting", {
        onInit: function () {
        },
        ...
        getDiagramEditorControl: function () {
            ...
            return oView && oView.byId("opRoutingGalileiEditor");
        },
